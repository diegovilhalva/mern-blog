...
const UpdatePost = () => {
    ...
    const handleUploadImage = async () => {
        try {
            ...
            uploadTask.on(
                ...
                (error) => {
                    setImageUploadError("Erro ao fazer o upload")
            ...
            setImageUploadError("Erro ao carregar imagem")
            setImageUploadProgress(null)
            console.log(error)
        }
    }
    ...
    const handleSubmit =  async(e) => {
        ...
        try {
            ...
            setPublishError("Ocorreu um erro, tente novamente mais tarde ")
        }
    }
  ...
  return (
    <div className="p-3 max-w-3xl mx-auto min-h-screen">
        ...
        <form  className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <ReactQuill theme="snow" value={formData.content}  placeholder="Escreva algo interessante"   className="h-72 mb-12" required    onChange={(value) => {
            setFormData({ ...formData, content: value })
         }} />
            <Button type="submit" gradientDuoTone={'purpleToPink'}>Atualizar</Button>
            {
